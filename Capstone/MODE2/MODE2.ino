...
//to remove since we have a working javascript script that does that.
...
client.println("  }");
client.println("  delayjava(5000).then(() => {"); // 5-second delay
...
client.println("    }");
client.println("    // Call setMode2Running(false) after all requests are sent");
client.println("    setTimeout(() => {");
...
client.println("        i++;");
client.println("        setTimeout(sendNext, 500); // Delay between requests");
client.println("      } else {");
client.println("        clearRoutine();");
client.println("      }");
client.println("    }");
client.println("    sendNext();");
client.println("  }");
...
client.println("}");
              ...
              client.println("       <p><button class=\"button mode1Button\" onclick=\"setMode2Running(true); sendRepeatedRequest('/Mode2running', " + String(birdieCountGlobal) + ", 1000)\">Mode 2 rep</button></p>");
