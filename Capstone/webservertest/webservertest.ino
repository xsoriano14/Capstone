        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            if(Mode == "Mode1"){
              ...
              client.println("       <a href=\"/Mode2\"><button class=\"button mode2\">1</button></a>");
              client.println("       <a href=\"/Mode2\"><button class=\"button mode2\">2</button></a>");
              client.println("       <a href=\"/Mode2\"><button class=\"button mode2\">3</button></a>");
            } else {
