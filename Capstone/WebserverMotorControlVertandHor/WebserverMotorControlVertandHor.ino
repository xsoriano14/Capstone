...
void loop() {
  ...
  //mybrushless.write(0);
            ...
            //  mybrushless.write(20);
              ...
              Serial.println("left, vertical pos5");
             // output26State = "off";
              Mode = "Mode1";
              digitalWrite(2, LOW);
              myservo.write(10);
...
client.println("        }");
           ...
           // }
            if(Mode == "Mode1"){
              ...
              client.println("       <a href=\"/Mode1/pos1\"><button class=\"button mode2/pos1\">Close-Middle</button></a>");
              client.println("       <a href=\"/Mode1/pos2\"><button class=\"button mode2/pos2\">Middle-Middle</button></a>");
              client.println("       <a href=\"/Mode1/pos3\"><button class=\"button mode2/pos3\">Far-Middle</button></a>");
             
              
              client.println("       <a href=\"/Mode1/pos8\"><button class=\"button on-off\">Close-Left</button></a>");
              client.println("       <a href=\"/Mode1/pos9\"><button class=\"button on-off\">Middle-Left</button></a>"); 
              client.println("       <a href=\"/Mode1/pos4\"><button class=\"button on-off\">Far-Left Test</button></a>");

              client.println("       <a href=\"/Mode1/pos5\"><button class=\"button mode2\">Close-Right</button></a>");
              client.println("       <a href=\"/Mode1/pos6\"><button class=\"button mode2\">Middle-Right</button></a>");
              client.println("       <a href=\"/Mode1/pos7\"><button class=\"button mode2\">Far-Right</button></a>");

             // client.println("       <a href=\"/Mode1/pos8\"><button class=\"button on-off\">Close-Left</button></a>");
             // client.println("       <a href=\"/Mode1/pos9\"><button class=\"button on-off\">Middle-Left</button></a>");
              client.println("       <a href=\"/Mode1/pos10\"><button class=\"button on-off\">TEST1</button></a>");
              client.println("       <a href=\"/Mode1/pos11\"><button class=\"button on-off\">TEST2</button></a>");
